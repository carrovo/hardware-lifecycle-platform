...
export const projects = [
  { id: 'PROJ-001', name: '智魔方项目', client: '智魔方科技有限公司', contactPerson: '采购负责人', contactPhone: '13800138001', background: '为智魔方科技园区引入智能搬运机器人，提升产线自动化水平。含生产计划、交付计划、在线运营、健康告警、质量问题与售后工单全链路。', notes: '优先保障A厂房产线交付', targetCount: 12, manager: '张三', status: '进行中', erpProjectNo: 'ERP-PJ-2026-001', members: [{ name: '张三', role: '项目负责人' }, { name: '李四', role: '生产协同' }, { name: '王五', role: '质量协同' }, { name: '赵六', role: '交付协同' }, { name: '蔡八', role: 'ERP 协同' }], createdAt: '2026-04-05 09:00', updatedAt: '2026-06-22 10:00' },
