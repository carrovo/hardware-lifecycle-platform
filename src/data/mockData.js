...
export const moduleInstances = _buildModuleInstances();

// ============ 项目（5 个演示项目）============
export const projects = [
  { id: 'PROJ-001', name: '智魔方项目', client: '智魔方科技有限公司', contactPerson: '采购负责人', contactPhone: '13800138001', background: '为智魔方科技园区引入智能搬运机器人，提升产线自动化水平。含生产计划、交付计划、在线运营、健康告警、质量问题与售后工单全链路。', notes: '优先保障A厂房产线交付', targetCount: 12, manager: '张三', status: '进行中', erpProjectNo: 'ERP-PJ-2026-001', createdAt: '2026-04-05 09:00', updatedAt: '2026-06-22 10:00' },
  { id: 'PROJ-002', name: '华熙生物项目', client: '华熙生物科技股份有限公司', contactPerson: '项目对接人', contactPhone: '13900139002', background: '为华熙生物园区部署 AlphaBot 2 智能物流机器人，含 AlphaBot 2 生产计划、交付中计划、在线运营设备与交付质量问题。', notes: '需满足生物园区洁净环境要求', targetCount: 8, manager: '李四', status: '进行中', erpProjectNo: 'ERP-PJ-2026-002', createdAt: '2026-04-10 10:00', updatedAt: '2026-06-22 09:00' },
  { id: 'PROJ-003', name: '机场项目', client: '首都国际机场集团', contactPerson: '运营负责人', contactPhone: '13700137003', background: '在机场航站楼部署巡检机器人，含追加生产计划、T3 试点交付、T2 点位部署中。', notes: '防护等级需IP65以上，需通过民航安全认证', targetCount: 8, manager: '王五', status: '进行中', erpProjectNo: 'ERP-PJ-2026-003', createdAt: '2026-04-12 10:00', updatedAt: '2026-06-21 15:00' },
  { id: 'PROJ-004', name: '医疗康养项目', client: '深圳南山医院', contactPerson: '设备科负责人', contactPhone: '13500135005', background: '院内药品、耗材、检验样本跨楼层配送。以待交付/待绑定设备池为主，含少量未关闭交付工单。', notes: '电梯联动接口暂未开放，先做单楼层闭环演示', targetCount: 4, manager: '赵六', status: '进行中', createdAt: '2026-06-01 11:00', updatedAt: '2026-06-21 14:00' },
  { id: 'PROJ-005', name: '展厅演示项目', client: '内部展厅', contactPerson: '品牌部', contactPhone: '13300133007', background: '展厅样机演示项目，承载历史关闭质量问题、已关闭工单、已停用点位与退役归档设备样例，不影响主流程看板。', notes: '仅用于历史/归档演示', targetCount: 4, manager: '张三', status: '进行中', erpProjectNo: 'ERP-PJ-2026-005', createdAt: '2026-02-20 09:00', updatedAt: '2026-06-05 18:00' },
];
...
// ============ 健康告警（仅引用在线运营/交付后设备；轻微=低，严重=高）============
const _nu = (n, r) => ({ name: n, role: r });
export const alerts = [
  { id: 'ALERT-001', deviceId: 'DEV-301', projectId: 'PROJ-001', deviceSN: 'SN-DEV-301', alertTime: '2026-06-22 02:05', source: '系统自动', severity: '轻微', description: '机械臂关节润滑度不足，运行摩擦力增大', status: '待处理', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('蔡八', '项目负责人')], processLogs: [] },
  { id: 'ALERT-002', deviceId: 'DEV-303', projectId: 'PROJ-001', deviceSN: 'SN-DEV-303', alertTime: '2026-06-20 22:40', source: '系统自动', severity: '轻微', description: '存储空间使用率超过70%，建议清理日志', status: '处理中', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('蔡八', '项目负责人')], processLogs: [{ operator: '赵六', time: '2026-06-21 07:00', fromStatus: '待处理', toStatus: '处理中', notes: '已远程连接，正在清理日志' }] },
  { id: 'ALERT-003', deviceId: 'DEV-304', projectId: 'PROJ-001', deviceSN: 'SN-DEV-304', alertTime: '2026-06-21 22:10', source: '系统自动', severity: '严重', description: '设备离线超过8小时，现场人员无法连接', status: '待处理', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('李七', '厂长')], processLogs: [] },
  { id: 'ALERT-004', deviceId: 'DEV-302', projectId: 'PROJ-001', deviceSN: 'SN-DEV-302', alertTime: '2026-06-20 18:30', source: '系统自动', severity: '轻微', description: 'CPU使用率持续超过85%，任务响应延迟', status: '处理中', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('蔡八', '项目负责人')], processLogs: [{ operator: '赵六', time: '2026-06-20 19:15', fromStatus: '待处理', toStatus: '处理中', notes: '后台日志服务异常占用CPU，正在清理' }] },
  { id: 'ALERT-005', deviceId: 'DEV-301', projectId: 'PROJ-001', deviceSN: 'SN-DEV-301', alertTime: '2026-06-19 03:22', source: '系统自动', severity: '轻微', description: '电池电量低于20%，建议及时充电', status: '已解决', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('蔡八', '项目负责人')], processLogs: [{ operator: '赵六', time: '2026-06-19 06:00', fromStatus: '待处理', toStatus: '处理中', notes: '已收到告警，安排现场充电' }, { operator: '赵六', time: '2026-06-19 08:30', fromStatus: '处理中', toStatus: '已解决', notes: '设备已充电完成，电量恢复至78%' }] },
  { id: 'ALERT-006', deviceId: 'DEV-305', projectId: 'PROJ-002', deviceSN: 'SN-DEV-305', alertTime: '2026-06-21 06:10', source: '系统自动', severity: '轻微', description: '导航模块定位漂移，偏差超过阈值0.3m', status: '处理中', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('蔡八', '项目负责人')], processLogs: [{ operator: '赵六', time: '2026-06-21 07:00', fromStatus: '待处理', toStatus: '处理中', notes: '正在排查定位漂移，可能是地图数据老化' }] },
  { id: 'ALERT-007', deviceId: 'DEV-307', projectId: 'PROJ-002', deviceSN: 'SN-DEV-307', alertTime: '2026-06-20 14:15', source: '系统自动', severity: '严重', description: '关节3电机过热，温度达到92°C，超过阈值', status: '已生成工单', workOrderId: 'WO-008', notifiedUsers: [_nu('赵六', '运维工程师'), _nu('李七', '厂长')], processLogs: [{ operator: '赵六', time: '2026-06-20 14:30', fromStatus: '待处理', toStatus: '已生成工单', notes: '严重告警，已生成换件工单 WO-008' }] },
  { id: 'ALERT-008', deviceId: 'DEV-306', projectId: 'PROJ-002', deviceSN: 'SN-DEV-306', alertTime: '2026-06-22 07:40', source: '人工上报', severity: '轻微', description: '充电桩对接偶发失败，需人工辅助', status: '待处理', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('蔡八', '项目负责人')], processLogs: [] },
  { id: 'ALERT-009', deviceId: 'DEV-308', projectId: 'PROJ-003', deviceSN: 'SN-DEV-308', alertTime: '2026-06-21 01:05', source: '系统自动', severity: '严重', description: '预控模组通信中断超过5分钟', status: '工单处理中', workOrderId: 'WO-005', notifiedUsers: [_nu('赵六', '运维工程师'), _nu('李七', '厂长')], processLogs: [{ operator: '赵六', time: '2026-06-21 01:10', fromStatus: '待处理', toStatus: '已生成工单', notes: '严重告警，已生成软件问题工单 WO-005' }] },
  { id: 'ALERT-010', deviceId: 'DEV-309', projectId: 'PROJ-003', deviceSN: 'SN-DEV-309', alertTime: '2026-06-22 07:55', source: '人工上报', severity: '严重', description: '主控板过压保护触发，设备紧急停机', status: '待处理', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('李七', '厂长')], processLogs: [] },
  { id: 'ALERT-011', deviceId: 'DEV-310', projectId: 'PROJ-003', deviceSN: 'SN-DEV-310', alertTime: '2026-06-20 18:30', source: '系统自动', severity: '轻微', description: '末端执行器抓取精度下降，误差约±2mm', status: '处理中', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('蔡八', '项目负责人')], processLogs: [{ operator: '李四', time: '2026-06-20 20:00', fromStatus: '待处理', toStatus: '处理中', notes: '检查末端传感器，准备重新标定' }] },
  { id: 'ALERT-012', deviceId: 'DEV-303', projectId: 'PROJ-001', deviceSN: 'SN-DEV-303', alertTime: '2026-06-10 14:20', source: '系统自动', severity: '严重', description: '关节2位置反馈异常，编码器读数跳变', status: '已关闭', workOrderId: 'WO-003', notifiedUsers: [_nu('赵六', '运维工程师'), _nu('李七', '厂长')], processLogs: [{ operator: '赵六', time: '2026-06-10 14:30', fromStatus: '待处理', toStatus: '已生成工单', notes: '编码器故障，已生成换件工单 WO-003' }, { operator: '李四', time: '2026-06-18 17:00', fromStatus: '工单处理中', toStatus: '已关闭', notes: '对应工单复检通过，设备恢复正常' }] },
  { id: 'ALERT-013', deviceId: 'DEV-307', projectId: 'PROJ-002', deviceSN: 'SN-DEV-307', alertTime: '2026-06-15 08:55', source: '系统自动', severity: '轻微', description: '语音播报模块偶发无声', status: '已解决', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师'), _nu('蔡八', '项目负责人')], processLogs: [{ operator: '赵六', time: '2026-06-15 10:00', fromStatus: '待处理', toStatus: '处理中', notes: '扬声器积灰，清洁中' }, { operator: '赵六', time: '2026-06-16 09:00', fromStatus: '处理中', toStatus: '已解决', notes: '清洁后恢复正常' }] },
  // 历史归档设备的已关闭告警（交付后退役设备，仅保留历史）
  { id: 'ALERT-014', deviceId: 'DEV-401', projectId: 'PROJ-005', deviceSN: 'SN-DEV-401', alertTime: '2026-05-10 10:00', source: '系统自动', severity: '轻微', description: '展厅样机电量偏低提醒', status: '已关闭', workOrderId: null, notifiedUsers: [_nu('赵六', '运维工程师')], processLogs: [{ operator: '赵六', time: '2026-05-10 12:00', fromStatus: '待处理', toStatus: '已关闭', notes: '样机退役归档前已闭环' }] },
  { id: 'ALERT-015', deviceId: 'DEV-402', projectId: 'PROJ-005', deviceSN: 'SN-DEV-402', alertTime: '2026-05-12 10:00', source: '系统自动', severity: '严重', description: '展厅样机主控偶发重启', status: '已关闭', workOrderId: 'WO-009', notifiedUsers: [_nu('赵六', '运维工程师'), _nu('李七', '厂长')], processLogs: [{ operator: '赵六', time: '2026-05-12 11:00', fromStatus: '待处理', toStatus: '已生成工单', notes: '已生成工单 WO-009' }, { operator: '李四', time: '2026-05-20 17:00', fromStatus: '工单处理中', toStatus: '已关闭', notes: '样机退役，工单归档关闭' }] },
];
...
export const moduleReplacements = [
  { id: 'MR-001', workOrderId: 'WO-003', deviceId: 'DEV-301', slotName: '左臂槁位', removedMaterialId: 'MAT-003', addedMaterialId: 'MAT-004', removedDisposition: '维修中', operator: '李四', timestamp: '2026-06-15 09:30', notes: '机械臂关节磨损，整体更换' },
  { id: 'MR-002', workOrderId: 'WO-001', deviceId: 'DEV-303', slotName: '预控槁位', removedMaterialId: 'MAT-013', addedMaterialId: 'MAT-014', removedDisposition: '维修中', operator: '王五', timestamp: '2026-06-20 15:30', notes: '预控模块散热异常，更换后送修' },
];
