...
export const devices = [
  ...
  { id: 'DEV-010', sn: 'SN-DEV-010', locationId: 'LOC-001', deviceTypeId: 'DT-001', status: '在线运营', assembler: '李四', assemblyTime: '2026-04-20 09:00', photoName: 'assembly_dev010.jpg', usedMaterials: [{ materialId: 'MAT-016', moduleTypeId: 'MT-003' }, { materialId: 'MAT-017', moduleTypeId: 'MT-003' }], projectId: 'PROJ-001', productionPlanId: 'WPP-001', erpInboundNo: 'PI-2026-015', erpInspectionNo: 'QC-2026-015', erpInspectionStatus: '合格', erpStockStatus: '合格可用', erpSerialNo: 'SN-DEV-010', batteryPercent: 87, storagePercent: 42, lastHeartbeat: '2026-06-21 08:55', online: true, createdAt: '2026-04-20 09:00', updatedAt: '2026-06-21 08:55' },
  ...
  { id: 'DEV-013', sn: 'SN-DEV-013', locationId: 'LOC-001', deviceTypeId: 'DT-001', status: '在线运营', assembler: '张三', assemblyTime: '2026-03-25 10:00', photoName: 'assembly_dev013.jpg', usedMaterials: [], projectId: 'PROJ-001', productionPlanId: 'WPP-001', erpInboundNo: 'PI-2026-015', erpInspectionNo: 'QC-2026-015', erpInspectionStatus: '合格', erpStockStatus: '合格可用', erpSerialNo: 'SN-DEV-013', batteryPercent: 93, storagePercent: 30, lastHeartbeat: '2026-06-21 09:02', online: true, createdAt: '2026-03-25 10:00', updatedAt: '2026-06-21 09:02' },
  ...
  { id: 'DEV-025', sn: 'SN-DEV-025', locationId: 'LOC-002', deviceTypeId: 'DT-001', status: '在线运营', assembler: '王五', assemblyTime: '2026-04-28 10:00', photoName: 'assembly_dev025.jpg', usedMaterials: [], projectId: 'PROJ-001', productionPlanId: 'WPP-001', erpInboundNo: 'PI-2026-015', erpInspectionNo: 'QC-2026-015', erpInspectionStatus: '合格', erpStockStatus: '合格可用', erpSerialNo: 'SN-DEV-025', batteryPercent: 91, storagePercent: 18, lastHeartbeat: '2026-06-22 09:00', online: true, createdAt: '2026-04-28 10:00', updatedAt: '2026-06-22 09:00' },
...
export const testRecords = [
  ...
  // WPP-001：DEV-007/010/013/025 全工站 Pass（已入库/在线运营）；DEV-008 初测 NG（返修中）
  ...['DEV-007', 'DEV-010', 'DEV-013', 'DEV-025'].flatMap((did, di) => [
    { id: `TEST-S1-${did}`, deviceId: did, stationKey: 'semi', stationResult: 'Pass', testType: '功能测试', result: '合格', operator: '张三', testTime: `2026-05-1${di} 09:00`, reportFile: `semi_${did}.pdf`, reportLink: '', notes: '半成品检验通过', status: '有效' },
    { id: `TEST-I1-${did}`, deviceId: did, stationKey: 'init', stationResult: 'Pass', testType: '功能测试', result: '合格', operator: '王五', testTime: `2026-05-1${di} 11:00`, reportFile: `init_${did}.pdf`, reportLink: '', notes: '初测通过', status: '有效' },
    { id: `TEST-M1-${did}`, deviceId: did, stationKey: 'mid', stationResult: 'Pass', testType: '老化测试', result: '合格', operator: '王五', testTime: `2026-05-1${di} 14:00`, reportFile: `aging_${did}.pdf`, reportLink: '', notes: '中测通过', status: '有效' },
    { id: `TEST-O1-${did}`, deviceId: did, stationKey: 'oqt', stationResult: 'Pass', testType: '其他', result: '合格', operator: '张三', testTime: `2026-05-1${di} 16:00`, reportFile: `oqt_${did}.pdf`, reportLink: '', notes: 'OQT终测通过', status: '有效' },
  ]),
...
export const qualityIssues = [
  { id: 'QI-001', deviceId: 'DEV-010', deviceSN: 'SN-DEV-010', deviceName: 'AlphaBot 2', locationId: 'LOC-001', projectId: 'PROJ-001', issueDesc: '机器人在货架转角处导航异常，频繁停止等待', reporterId: 'user-zhaoliu', reporterName: '赵六', reportTime: '2026-06-22 14:30', status: '待处理', source: '扫码上报', processLogs: [] },
  { id: 'QI-002', deviceId: 'DEV-013', deviceSN: 'SN-DEV-013', deviceName: 'AlphaBot 1', locationId: 'LOC-001', projectId: 'PROJ-001', issueDesc: '设备运行时发出异常响声，疑似关节松动', reporterId: 'user-zhangsan', reporterName: '张三', reportTime: '2026-06-21 09:15', status: '处理中', source: '手动录入', processLogs: [{ time: '2026-06-21 11:00', operator: '李四', fromStatus: '待处理', toStatus: '处理中', notes: '已到场确认，关节螺丝松动，正在紧固' }] },
  { id: 'QI-003', deviceId: 'DEV-025', deviceSN: 'SN-DEV-025', deviceName: 'AlphaBot 2', locationId: 'LOC-002', projectId: 'PROJ-001', issueDesc: '屏幕显示异常，出现竖条纹花屏', reporterId: 'user-wangwu', reporterName: '王五', reportTime: '2026-06-20 16:45', status: '已关闭', source: '扫码上报', processLogs: [{ time: '2026-06-20 17:30', operator: '赵六', fromStatus: '待处理', toStatus: '处理中', notes: '远程重启后恢复' }, { time: '2026-06-21 09:00', operator: '赵六', fromStatus: '处理中', toStatus: '已关闭', notes: '确认为软件渲染问题，已推送更新包' }] },
  { id: 'QI-004', deviceId: 'DEV-011', deviceSN: 'SN-DEV-011', deviceName: 'AlphaBot 1', locationId: 'LOC-003', projectId: 'PROJ-002', issueDesc: '充电桩对接不稳定，充电过程多次中断', reporterId: 'user-lisi', reporterName: '李四', reportTime: '2026-06-22 08:20', status: '待处理', source: '手动录入', processLogs: [] },
  { id: 'QI-005', deviceId: 'DEV-009', deviceSN: 'SN-DEV-009', deviceName: 'AlphaBot 1', locationId: 'LOC-004', projectId: 'PROJ-002', issueDesc: '设备在人群密集区域速度控制响应迟滞', reporterId: 'user-zhaoliu', reporterName: '赵六', reportTime: '2026-06-21 13:00', status: '处理中', source: '扫码上报', processLogs: [{ time: '2026-06-21 15:00', operator: '王五', fromStatus: '待处理', toStatus: '处理中', notes: '已排查，系感知延迟导致，正在调整参数' }] },
  { id: 'QI-006', deviceId: 'DEV-012', deviceSN: 'SN-DEV-012', deviceName: 'AlphaBot 2', locationId: 'LOC-005', projectId: 'PROJ-003', issueDesc: '电量低于20%时自主返回充电桩功能失效', reporterId: 'user-zhangsan', reporterName: '张三', reportTime: '2026-06-20 11:30', status: '已关闭', source: '手动录入', processLogs: [{ time: '2026-06-20 14:00', operator: '李四', fromStatus: '待处理', toStatus: '处理中', notes: '确认为固件bug，申请补丁' }, { time: '2026-06-22 10:00', operator: '李四', fromStatus: '处理中', toStatus: '已关闭', notes: '固件补丁已推送，功能验证通过' }] },
  { id: 'QI-007', deviceId: 'DEV-024', deviceSN: 'SN-DEV-024', deviceName: 'AlphaBot 1', locationId: 'LOC-006', projectId: 'PROJ-003', issueDesc: 'B区安检通道附近LIDAR点云数据丢失，影响避障', reporterId: 'user-wangwu', reporterName: '王五', reportTime: '2026-06-22 10:00', status: '待处理', source: '扫码上报', processLogs: [] },
  { id: 'QI-008', deviceId: 'DEV-010', deviceSN: 'SN-DEV-010', deviceName: 'AlphaBot 2', locationId: 'LOC-001', projectId: 'PROJ-001', issueDesc: '货架扫描识别率下降，特定条形码无法读取', reporterId: 'user-lisi', reporterName: '李四', reportTime: '2026-06-19 14:00', status: '处理中', source: '手动录入', processLogs: [{ time: '2026-06-19 16:00', operator: '张三', fromStatus: '待处理', toStatus: '处理中', notes: '摄像头镜头有污染，清洁后部分改善，继续观察' }] },
  { id: 'QI-009', deviceId: 'DEV-013', deviceSN: 'SN-DEV-013', deviceName: 'AlphaBot 1', locationId: 'LOC-001', projectId: 'PROJ-001', issueDesc: '设备在湿滑地面行进时偶发打滑，里程计偏差大', reporterId: 'user-zhaoliu', reporterName: '赵六', reportTime: '2026-06-18 09:30', status: '已关闭', source: '扫码上报', processLogs: [{ time: '2026-06-18 11:00', operator: '王五', fromStatus: '待处理', toStatus: '处理中', notes: '底盘轮胎磨损，已申请更换' }, { time: '2026-06-20 15:00', operator: '王五', fromStatus: '处理中', toStatus: '已关闭', notes: '轮胎更换完成，测试里程计误差在允许范围内' }] },
  { id: 'QI-010', deviceId: 'DEV-011', deviceSN: 'SN-DEV-011', deviceName: 'AlphaBot 1', locationId: 'LOC-003', projectId: 'PROJ-002', issueDesc: '机器人语音播报功能异常，提示音模糊', reporterId: 'user-zhangsan', reporterName: '张三', reportTime: '2026-06-17 15:20', status: '已关闭', source: '手动录入', processLogs: [{ time: '2026-06-17 17:00', operator: '赵六', fromStatus: '待处理', toStatus: '处理中', notes: '扬声器积灰，清洁后恢复正常' }, { time: '2026-06-18 09:00', operator: '赵六', fromStatus: '处理中', toStatus: '已关闭', notes: '持续监测24小时，问题未复现' }] },
  { id: 'QI-011', deviceId: 'DEV-024', deviceSN: 'SN-DEV-024', deviceName: 'AlphaBot 1', locationId: 'LOC-006', projectId: 'PROJ-003', issueDesc: '设备在人流高峰期响应指令延迟超过3秒', reporterId: 'user-lisi', reporterName: '李四', reportTime: '2026-06-22 11:45', status: '待处理', source: '扫码上报', processLogs: [] },
  { id: 'QI-012', deviceId: 'DEV-009', deviceSN: 'SN-DEV-009', deviceName: 'AlphaBot 1', locationId: 'LOC-004', projectId: 'PROJ-002', issueDesc: '地图更新后设备在旧路径巡逻，需重新配置路线', reporterId: 'user-wangwu', reporterName: '王五', reportTime: '2026-06-16 10:00', status: '已关闭', source: '手动录入', processLogs: [{ time: '2026-06-16 14:00', operator: '李四', fromStatus: '待处理', toStatus: '处理中', notes: '重新下发任务地图' }, { time: '2026-06-17 09:00', operator: '李四', fromStatus: '处理中', toStatus: '已关闭', notes: '路线配置完成，验证通过' }] },
];
